...
const projects = [
  ...
  },
  {
    ...
    description: '📗 Jumpstart your career as a JavaScript developer',
    link: {
...
export default function Projects() {
  return (
    <>
      ...
      <SimpleLayout
        title="Things that I've made trying to improve myself, for a living, or to give back to the open source world."
        intro="I've worked on many little projects over the years but these are the ones that I'm most proud of. Many of them are open-source, so if you see something that piques your interest, check out the code and contribute if you have ideas for how it can be improved."
      >
        <ul
          role="list"
