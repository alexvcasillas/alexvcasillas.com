...
export const meta = {
  ...
  description:
    "I've maintained open-source for a long time, I've maintained open-source on my own, everything that I do is bootstrapped and self-funded, but as the open-source projects grow, so the expenses do.",
}
...
- [Cratebox.io](https://cratebox.io) Support page 👉 [alexcasillas.gumroad.com/l/cratebox-support](alexcasillas.gumroad.com/l/cratebox-support)
...
- [Quick QR](https://www.quick-qr.app) support page 👉 [alexcasillas.gumroad.com/l/quick-qr-support](alexcasillas.gumroad.com/l/quick-qr-support)
